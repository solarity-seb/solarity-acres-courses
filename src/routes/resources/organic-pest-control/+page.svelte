<script lang="ts">
  ...
  async function handleEnroll() {
    ...
    const result = await enrollInResource(supabase, user.id, 'organic-pest-control');
  ...
  function viewContent() {
    if (enrolled) {
      goto('/private/resources/organic-pest-control');
    } else {
...
<SEO
  title="Organic Pest Control Mastery - Free Resource"
  ...
  url="/resources/organic-pest-control"
  noIndex={false}
/>
      ...
      <div class="card card-1 u-card-padding">
        ...
        <div class="testimonials">
          ...
          <div class="testimonial">
            <p>"Finally, a pest control method that works without harming beneficial insects. My garden is thriving!"</p>
            <cite>- Jennifer Adams</cite>
          </div>
          <div class="testimonial">
            <p>"The companion planting section alone saved my tomatoes. Comprehensive and practical guide."</p>
            <cite>- Robert Kim</cite>
          </div>
          <div class="testimonial">
            <p>"I've eliminated all chemical pesticides thanks to these techniques. My family and soil are healthier."</p>
            <cite>- Maria Gonzalez</cite>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-4">
      <div class="card card-2 u-card-padding sticky-card">
        ...
        <div class="resource-info">
          ...
          <div class="info-item">
            <strong>Reading Time:</strong> ~60 minutes
          </div>
        </div>
      </div>
    </div>
